...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> customerExpHandler(CustomerException ie, WebRequest req)  {
	...
	public ResponseEntity<ErrorDetails> deliveryPartnerExpHandler(CustomerException ie, WebRequest req)  {
